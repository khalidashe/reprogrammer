...
~28 days (the four foundation weeks of Cameron's 12-week course). The two daily/weekly practices are the whole engine — protect them.`,
    program: {
      primaryInstrument: 'journal',
      durationDays: 28,
      dailyMinutes: 35,
      setting: 'solo',
      pairsWith: ['pkg-feeling-good', 'pkg-deep-work'],
      days: [
        { day: 1, week: 1, theme: 'Recovering safety', exercises: [{ prompt: `Write your first morning pages — three longhand pages, anything that comes, even "I don't know what to write." Set the rule now: pages happen before your phone, every day of this program.`, minutes: 35, instrument: 'journal' }] },
        { day: 2, week: 1, theme: 'Recovering safety', exercises: [{ prompt: `Morning pages. Then, separately, describe your inner censor in a paragraph — the voice that critiques your creative impulses. Give it a name and a ridiculous appearance.`, minutes: 40, instrument: 'journal' }] },
        { day: 3, week: 1, theme: 'Recovering safety', exercises: [{ prompt: `Morning pages. Then list 5 phrases your censor uses verbatim ("who do you think you are", "this has been done"). Recognizing the script is half its disarmament.`, minutes: 40, instrument: 'journal' }] },
        { day: 4, week: 1, theme: 'Recovering safety', exercises: [{ prompt: `Morning pages. Then write 3 affirmations that directly answer your censor's top phrases — cheesy is fine; write each one 5 times.`, minutes: 40, instrument: 'journal' }] },
        { day: 5, week: 1, theme: 'Recovering safety', exercises: [{ prompt: `Morning pages. Then plan this week's artist date: one solo outing — art store, strange neighborhood, museum, forest. Put it on the calendar like a meeting.`, minutes: 35, instrument: 'journal' }] },
        { day: 6, week: 1, theme: 'Recovering safety', exercises: [{ prompt: `Artist date #1: go alone, phone on silent, no errands attached. You're not making anything — you're restocking the well. Mark done when you've taken it.`, minutes: 90, instrument: 'checkbox' }] },
        { day: 7, week: 1, theme: 'Weekly check', exercises: [{ prompt: `Morning pages + weekly check: how many of 7 days did you write? What surprised you in them? (Don't reread — answer from memory.)`, minutes: 40, instrument: 'journal' }] },
        { day: 8, week: 2, theme: 'Recovering identity', exercises: [{ prompt: `Morning pages. Then the buried-dreams list: 5 hobbies that sound fun, 5 things you'd love to learn, 5 things you used to enjoy, 5 silly things you'd try if nobody knew.`, minutes: 45, instrument: 'journal' }] },
        { day: 9, week: 2, theme: 'Recovering identity', exercises: [{ prompt: `Morning pages. Then list 5 "imaginary lives" you'd love to live (jazz pianist, marine biologist, monk...). Pick one and do a 10-minute fragment of it today.`, minutes: 45, instrument: 'journal' }] },
        { day: 10, week: 2, theme: 'Recovering identity', exercises: [{ prompt: `Morning pages. Then list your "crazymakers" and time-drains — people and habits that reliably eat the energy your creativity needs. Choose one boundary to hold this week.`, minutes: 40, instrument: 'journal' }] },
        { day: 11, week: 2, theme: 'Recovering identity', exercises: [{ prompt: `Morning pages. Then a time audit: where would 30 daily creative minutes come from? Find them by naming what they replace.`, minutes: 40, instrument: 'journal' }] },
        { day: 12, week: 2, theme: 'Recovering identity', exercises: [{ prompt: `Morning pages. Then plan artist date #2 — a different category from #1 (if #1 was visual, go auditory or kinesthetic).`, minutes: 35, instrument: 'journal' }] },
        { day: 13, week: 2, theme: 'Recovering identity', exercises: [{ prompt: `Artist date #2: another solo expedition. Alone, unproductive, delightful. Mark done when taken.`, minutes: 90, instrument: 'checkbox' }] },
        { day: 14, week: 2, theme: 'Weekly check', exercises: [{ prompt: `Morning pages + weekly check: streak count, boundary held or broken, and which buried dream keeps echoing.`, minutes: 40, instrument: 'journal' }] },
        { day: 15, week: 3, theme: 'Recovering power', exercises: [{ prompt: `Morning pages. Then the anger inventory: list 3 things that make you creatively envious or angry. Envy is a map — write what each one points to.`, minutes: 45, instrument: 'journal' }] },
        { day: 16, week: 3, theme: 'Recovering power', exercises: [{ prompt: `Morning pages. Then choose the creative project this program will re-open (the abandoned draft, the unlearned instrument, the unstarted blog). Write its name and the smallest possible first action.`, minutes: 40, instrument: 'journal' }] },
        { day: 17, week: 3, theme: 'Recovering power', exercises: [{ prompt: `Morning pages. Then do the project's smallest action today — 15 minutes maximum, quality explicitly irrelevant.`, minutes: 55, instrument: 'journal' }] },
        { day: 18, week: 3, theme: 'Recovering power', exercises: [{ prompt: `Morning pages. Project: 15 more minutes. When the censor speaks, write its comment on a sticky note, say "thank you, noted," and continue.`, minutes: 55, instrument: 'journal' }] },
        { day: 19, week: 3, theme: 'Recovering power', exercises: [{ prompt: `Morning pages. Then a well-filling walk: 20 minutes, no headphones, collecting 5 sensory details deliberately (a color, a sound, a texture...). Write them down after.`, minutes: 60, instrument: 'journal' }] },
        { day: 20, week: 3, theme: 'Recovering power', exercises: [{ prompt: `Artist date #3: a solo outing in yet another mode. Mark done when taken.`, minutes: 90, instrument: 'checkbox' }] },
        { day: 21, week: 3, theme: 'Weekly check', exercises: [{ prompt: `Morning pages + weekly check: project minutes logged, censor stickies collected, streak count.`, minutes: 40, instrument: 'journal' }] },
        { day: 22, week: 4, theme: 'Recovering integrity', exercises: [{ prompt: `Morning pages. Then begin the input-deprivation experiment (adapted): through Day 26, no recreational scrolling, browsing, or background video. Study reading is fine; the ban is on ambient input that fills silence. Notice what rushes into the space.`, minutes: 40, instrument: 'journal' }] },
        { day: [23, 25], week: 4, theme: 'Recovering integrity', exercises: [{ prompt: `Morning pages + 15–20 project minutes. The freed-up input hours will try to convert themselves into project time — let them.`, minutes: 60, instrument: 'journal' }] },
        { day: 26, week: 4, theme: 'Recovering integrity', exercises: [{ prompt: `Morning pages. Then write honestly: what did the input fast reveal about what you avoid by consuming?`, minutes: 45, instrument: 'journal' }] },
        { day: 27, week: 4, theme: 'Recovering integrity', exercises: [{ prompt: `Artist date #4: the last scheduled expedition. Mark done when taken.`, minutes: 90, instrument: 'checkbox' }] },
        { day: 28, week: 4, theme: 'Final review', exercises: [{ prompt: `Morning pages. Final review — now you may reread one early week of pages. Mark recurring themes in one color, censor attacks in another, buried wishes in a third. Decide: continue the full 12-week course, or keep pages + dates as a permanent practice.`, minutes: 60, instrument: 'journal' }] },
      ],
    },
  },
